...
while (i<200) {
  ...
  y_p_f<-cSMC_4(psi_spec_ini,FHN_LT_bridge_list_gen(V_20_e[-1],append((theta_old/scale_par+c_vec[i]*Delta_now)*scale_par,
                                                                      0,after = 3),T_step,n_bridge),y_4,2)
  psi_spec_ini<-y_p_f[[2]]
  y_m_f<-cSMC_4(psi_spec_ini,FHN_LT_bridge_list_gen(V_20_e[-1],append((theta_old/scale_par-c_vec[i]*Delta_now)*scale_par,
                                                                      0,after = 3),T_step,n_bridge),y_4,2)
  
  delta_now<-sample(c(1,-1),4,replace = T,prob = rep(0.5,2))
  
  psi_spec_ini<-y_p_f[[2]]
  y_p_f_d<-cSMC_4(psi_spec_ini,FHN_LT_bridge_list_gen(V_20_e[-1],append((theta_old/scale_par+d_vec[i]*delta_now+c_vec[i]*Delta_now)*scale_par,
                                                                        0,after = 3),T_step,n_bridge),y_4,2)
  psi_spec_ini<-y_p_f_d[[2]]
  y_m_f_d<-cSMC_4(psi_spec_ini,FHN_LT_bridge_list_gen(V_20_e[-1],append((theta_old/scale_par+d_vec[i]*delta_now-c_vec[i]*Delta_now)*scale_par,
                                                                        0,after = 3),T_step,n_bridge),y_4,2)
  ...
  l_new<-cSMC_4(psi_spec_ini,FHN_LT_bridge_list_gen(V_20_e[-1],append(par_new,
