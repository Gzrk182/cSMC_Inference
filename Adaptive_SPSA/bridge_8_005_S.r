...
tk_list_4<-FHN_S_bridge_list_gen(V_20_e[-1],append(par_vec[1,1:4],
                                                    0,after = 3),T_step,4)
tk_list_8<-FHN_S_bridge_list_gen(V_20_e[-1],append(par_vec[1,1:4],
                                                    0,after = 3),T_step,8)
...
while (i<200) {
  ...
  y_p_f<-cSMC_8(psi_spec_ini,FHN_S_bridge_list_gen(V_20_e[-1],append((theta_old/scale_par+c_vec[i]*Delta_now)*scale_par,
  ...
  y_m_f<-cSMC_8(psi_spec_ini,FHN_S_bridge_list_gen(V_20_e[-1],append((theta_old/scale_par-c_vec[i]*Delta_now)*scale_par,
                                                                      0,after = 3),T_step,n_bridge),y_8,2)
  ...
  delta_now<-sample(c(1,-1),4,replace = T,prob = rep(0.5,2))
  psi_spec_ini<-y_p_f[[2]]
  y_p_f_d<-cSMC_8(psi_spec_ini,FHN_S_bridge_list_gen(V_20_e[-1],append((theta_old/scale_par+d_vec[i]*delta_now+c_vec[i]*Delta_now)*scale_par,
                                                                        0,after = 3),T_step,n_bridge),y_8,2)
  ...
  y_m_f_d<-cSMC_8(psi_spec_ini,FHN_S_bridge_list_gen(V_20_e[-1],append((theta_old/scale_par+d_vec[i]*delta_now-c_vec[i]*Delta_now)*scale_par,
                                                                        0,after = 3),T_step,n_bridge),y_8,2)
  ...
  l_new<-cSMC_8(psi_spec_ini,FHN_S_bridge_list_gen(V_20_e[-1],append(par_new,
